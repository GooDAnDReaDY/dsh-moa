...
export class MoaRunnerAdapter {
  ...
  async *stream(options) {
    ...
    yield { type: 'text-delta', index: 0, text: '🧠 *Mixture of Agents запущен... опрашиваю советников и судью...*\n\n---\n\n' }

    const { targetPreset, userPrompt, messages, callLlm } = this.getMoaContext(options)
    ...
    try {
      ...
      yield { type: 'text-delta', index: 0, text: formatted }
